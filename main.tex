...
\begin{itemize}
\item Developed the full end-to-end experience for dependent breakpoints for Visual Studio 2022 which received nearly \href{https://twitter.com/VS_Debugger/status/1437902110822047750}{500 likes on the VS Debugger twitter} and received a CSAT score of 85
...
\item Used C\# to create a method for determining if memory is owned purely by a debugger-generated TypeProxy managed object or by the debuggee process which saved the debugger from displaying an incorrect error message 100+ times per month
\item Led a cohort of 20+ interns through Microsoft's Intern Cohort program which involved brainstorming 4 virtual events and organizing collaborations with other cohorts
\end{itemize}
